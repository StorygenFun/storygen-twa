...
export const Story: FC<StoryProps> = () => {
  ...
  const testMemory = async () => {
    ...
    console.log('🚀 ~ testMemory ~ memory:', memory)
    // return
...
AI:`)
    ...
    const memoryWithMetadata = new VectorStoreRetrieverMemory({
      vectorStoreRetriever: vectorStore.asRetriever(1, doc => doc.metadata?.userId === '1'),
      memoryKey: 'history',
    ...
    const memoryWithoutMatchingMetadata = new VectorStoreRetrieverMemory({
      vectorStoreRetriever: vectorStore.asRetriever(1, doc => doc.metadata?.userId === '2'),
      memoryKey: 'history',
    })
